...
model = keras.models.load_model("dyslexia-cnn-first-model.keras", custom_objects={"f1_metric": f1_metric})
print("✅ Model 'dyslexia-cnn-first-model.keras' loaded successfully.")

# Optional: Unfreeze final Dense layer for fine-tuning (if frozen previously)
for layer in model.layers:
    layer.trainable = True  # Ensure entire model is trainable
